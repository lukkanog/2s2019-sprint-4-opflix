...
class EditarLancamento extends Component {
    ...
    _editarLancamento = async () => {
        try {
            ...
            fetch("http://192.168.4.16:5000/api/lancamentos/" + id.toString(), {
                method: "PUT",
                headers: {
                    "Authorization" : "Bearer " + token,
                ...
                body: JSON.stringify({
                    ...
                    dataLancamento: this.state.dataLancamento.toString(),
            ...
            <SafeAreaView>
                ...
                <View>
                    ...
                    <View>
                        ...
                        <Picker
                            selectedValue={this.state.lancamento.idTipoLancamento}
                    ...
                    <View>
                        ...
                        <Picker
                            selectedValue={this.state.lancamento.idPlataforma}
                    ...
                    <View>
                        <Text>Categoria</Text>
                        <Picker
                            selectedValue={this.state.lancamento.idCategoria}
                    ...
                    <View>
                        ...
                        <DatePicker
                            ...
                            date={this.state.dataLancamento !== "" ? this.state.dataLancamento : this.state.lancamento.dataLancamento}
                            mode="date"
